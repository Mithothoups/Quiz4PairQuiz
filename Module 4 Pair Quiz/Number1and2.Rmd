...
Computing for the standard errors of the regression coefficients requires a lot of Math that are very complicated if solved manually. However, using an external application, we managed to solve the standard errors of each regression coefficients:
